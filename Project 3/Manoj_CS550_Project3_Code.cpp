...
#define XSIDE	5.0		// length of the x side of the grid
...
#define ZSIDE	5.0		// length of the z side of the grid
...
const char* WINDOWTITLE = "OpenGL / GLUT Sample -- Manoj Graphics Project 3";
...
Display()
{
	...
	gluLookAt(0.f, 13.f, 8.f, 0.f, 0.f, 2.f, 0.f, 1.f, 0.f);
	...
	if (PointLight) {
		...
		SetPointLight(GL_LIGHT0, 3., 6, 0., LightSourceColor[0], LightSourceColor[1], LightSourceColor[2]);
	}
	else {
		SetSpotLight(GL_LIGHT0, 3., 6, 0., 0., -1., 0., LightSourceColor[0], LightSourceColor[1], LightSourceColor[2]);
	}
	glTranslatef(3., 6, 0.);
	glColor3f(LightSourceColor[0], LightSourceColor[1], LightSourceColor[2]);
	...
	//	glPushMatrix();
	//	glRotatef(GLfloat(i * 360 / NumberOfHorses) , 0., 1., 0.);
	//	double cosWaveAngle = Time * M_PI * 2 / 0.25 + i * M_PI / 2; // 1/4 = 0.25 -> The horse uses cos wave 4 times to complete the circle 
	//	double faceAngleOscillation = cos(cosWaveAngle) * 24;	
	//	glTranslatef(0.f, GLfloat(cos(cosWaveAngle)) - 0.2f, 2.0f);
	//	glRotatef(GLfloat(faceAngleOscillation), 0., 0., 1);
	//	glScalef(0.9f, 0.9f, 0.9f);
	//	glCallList(PolygonHorseList);
	//	glPopMatrix();
	//}
...
InitLists()
{
	...
	SetMaterial(1.f, 0.f, 0.f, 100.f);
	glScalef(0.4,0.4,0.4);
	LoadObjFile((char*)"dog.obj");
	glPopMatrix();
	glPushMatrix();
	SetMaterial(0.f, 1.f, 0.f, 10.f);
	glTranslatef(1., 0.0, -1.);
	glRotatef(90, 0, 1, 0);
	...
	glPopMatrix();
	glPushMatrix();
	SetMaterial(1.f, 1.f, 0.f, 50.f);
	glTranslatef(0., 0.5, 0);
	OsuSphere(0.5, 100, 100);
	glPopMatrix();
	glPushMatrix();
	SetMaterial(1.f, 0.7f, 0.f, 100.f);
	glTranslatef(0., 0.5, 1.5);
	OsuTorus(0.1, 0.3, 100, 100);
	glPopMatrix();
	glPushMatrix();
	SetMaterial(1.f, 0.7f, 0.f, 0.f);
	glTranslatef(0., 0.5, -1.5);
	OsuCone(0.4, 0.1, 1, 100, 100);
	glPopMatrix();
	glPushMatrix();
	glColor3f(1., 0., 0.);
	...
	for (int i = 0; i < 10000; i++) {
		double angle = 2.0f * M_PI * float(i) / float(10000);  
		double x = 2 * cos(angle);
		double z = 2 * sin(angle);
