...
const char* WINDOWTITLE = "OpenGL / GLUT Sample -- Manoj Graphics Project 2";
...
Display()
{
	...
	if (InView == 1) {
		gluLookAt(0.f, 0.f, 0.f, 0.f, 0.f, 2.f, 0.f, 1.f, 0.f);

	}
	else {
		gluLookAt(0.f, 0.f, 6.f, 0.f, 0.f, 2.f, 0.f, 1.f, 0.f);
...
void PolygonHorse() {
	PolygonHorseList = glGenLists(1);
	glNewList(PolygonHorseList, GL_COMPILE);
	glPushMatrix();
...
void WireHorse() {
	...
	glPushMatrix();
	glRotatef(90.0, 0., 1., 0.);
	glColor3f(1.f, 1.f, 0.f);	// yellow color for horses
	glBegin(GL_LINES);
