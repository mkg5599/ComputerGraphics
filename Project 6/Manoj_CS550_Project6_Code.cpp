...
float NowS0, NowT0, NowD, NowD2;
GLSLProgram Pattern;

Keytimes xCenter, yCenter;

bool KeytimePatternOn, TimePatternOn;
...
Display( )
{
	...
	gluLookAt( 1.5f, 1.f, 1.5f,     0.f, 0.f, 0.f,     0.f, 1.f, 0.f );
	...
	int msec = glutGet(GLUT_ELAPSED_TIME) % 10000;
	float nt = (float)msec / 1000.;




	float angleForEllipse = 2 * M_PI * Time;


	if (TimePatternOn) {
    NowD = 0.04 + (0.04 * abs(cos(angleForEllipse)));
    NowD2 = 0.04 + (0.12 * abs(sin(angleForEllipse)));
	} else {
	...
	if (KeytimePatternOn) {
		NowS0 = xCenter.GetValue(nt);
		NowT0 = yCenter.GetValue(nt);
	} else {
		NowS0 = 0.5;
		NowT0 = 0.5;
	}
	...
	Pattern.SetUniformVariable( "uD2" , NowD2  );
...
InitGraphics( )
{
	...
	xCenter.AddTimeValue(0.0, 0.5);
	xCenter.AddTimeValue(2.5, 0.6);
	xCenter.AddTimeValue(5.0, 0.75);
	xCenter.AddTimeValue(7.5, 0.6);
	xCenter.AddTimeValue(10.0, 0.5);

	yCenter.AddTimeValue(0.0, 0.5);
	yCenter.AddTimeValue(2.5, 0.52);
	yCenter.AddTimeValue(5.0, 0.75);
	yCenter.AddTimeValue(7.5, 0.6);
	yCenter.AddTimeValue(10.0, 0.5);
